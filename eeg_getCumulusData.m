function [data, trl] = eeg_getCumulusData(cfg,filename)
...
disp('Getting Data...')
M = csvread(filename,headerLines,0,[headerLines,0,lastline-2,(nIndex + nEEG + nAccel + nTime)-1]);
...
data.trial{1} = M(:,2:nEEG+1)';             % cell-array containing a data matrix for each 
